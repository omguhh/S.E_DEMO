...
--
-- Host: localhost
-- Generation Time: Feb 26, 2015 at 08:17 PM
...
CREATE TABLE IF NOT EXISTS `purchase_history` (
  ...
  PRIMARY KEY (`client_name`,`fa_name`),
...
INSERT INTO `purchase_history` (`client_name`, `fa_name`, `stock_name`, `date_brought`) VALUES
('clientdude', 'sonia santa', 'msft', '2015-03-01'),
('naiyarah hussain', 'sonia santa', 'toyota', '2015-02-26'),
('shoaib mawani', 'hakim moti', 'futtaim', '2015-02-27');
